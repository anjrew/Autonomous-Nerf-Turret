        ...
        for event in events:
            ...
            if event.type == pygame.JOYAXISMOTION:
                ...
                if event.axis == args.elevation_button:
                    ...
                    elevation = round(map_range(event.value, -1, 1, CONTROLLER_Y_OUTPUT_RANGE[0], CONTROLLER_Y_OUTPUT_RANGE[1]))
                ...
                if event.axis == args.azimuth_button:
                    ...
                    azimuth_angle = round(map_range(event.value,-1, 1, CONTROLLER_X_OUTPUT_RANGE[0], CONTROLLER_X_OUTPUT_RANGE[1]))
